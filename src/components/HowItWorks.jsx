        ...
        <section className='common-padding'>
            <div className='screen-max-width'>
                ...
                <div className='mt-10 md:mt-20 mb-14' >
                    <div className='relative h-full w-full flex-center' id='iphone-mockup'>
                        <div className='overflow-hidden w-full flex justify-center'>
                            <img src={frameImg} alt="frame" className='bg-transparent relative z-10' />
                        </div>
                        <div className='hiw-video w-full h-full flex justify-center items-center'>
                            <video
                                src={frameVideo}
                ...
                <div className='hiw-text-container md:items-start'>
